...
/* harmony export */   changeDeep: () => (/* binding */ changeDeep),
/* harmony export */   checkOmegaDSAvailable: () => (/* binding */ checkOmegaDSAvailable),
/* harmony export */   fetchJSONColors: () => (/* binding */ fetchJSONColors),
/* harmony export */   loadTeamPaintStyles: () => (/* binding */ loadTeamPaintStyles)
/* harmony export */ });
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! buffer */ "./node_modules/buffer/index.js");

const checkOmegaDSAvailable = async () => {
...
async function fetchJSONColors(token) {
    ...
    return fetch(`https://api.github.com/repos/${owner}/${repo}/contents/${path}`, {
        ...
        .then((res) => res.json())
        .then((d) => JSON.parse(buffer__WEBPACK_IMPORTED_MODULE_0__.Buffer.from(d.content, 'base64').toString('utf8')));
}
function loadTeamPaintStyles(globalMap) {
    let localMap = {};
...
function changeDeep(node, colorsMapGlobal) {
    let as_frame_node = node;
...
let colorsMapGlobal = {};
const loadColorStyles = (token) => {
    (0,_funcs__WEBPACK_IMPORTED_MODULE_0__.fetchJSONColors)(token)
        .then((file) => {
            ...
            if (token !== undefined) {
                ...
                if (selection.length > 0) {
                    for (const selected of selection) {
                        (0,_funcs__WEBPACK_IMPORTED_MODULE_0__.changeDeep)(selected, colorsMapGlobal);
                    }
                }
                else {
